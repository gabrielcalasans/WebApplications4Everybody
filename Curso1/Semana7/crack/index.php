<!DOCTYPE html>
<head><title>Gabriel da Silva Calasans</title></head>
<body>
<h1>MD5 cracker</h1>
<p>This application takes an MD5 hash
of a four pin password and
...
if ( isset($_GET['md5']) ) {
    ...
    for($i=0; $i<strlen($txt); $i++ ) {
        ...
        for($j=0; $j<strlen($txt); $j++ ) {
            $ch2 = $txt[$j]; // The second of four numbers
            
            for($k=0; $k<strlen($txt); $k++ ) {
            $ch3 = $txt[$k]; // The third of four numbers
                
                
                for($l=0; $l<strlen($txt); $l++ ) {
                    $ch4 = $txt[$l];  // The last number
